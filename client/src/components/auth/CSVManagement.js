...
const CSVManagement = ({ getProfiles, profile: { profiles, loading }, deleteAccount, getUsersCSVString, getProfileCSVString, getCombinedCSVString, uploadCsv, setAlert }) => {
...
export default connect(mapStateToProps, { getProfiles, deleteAccount, getUsersCSVString, getProfileCSVString, getCombinedCSVString, setAlert, uploadCsv })(CSVManagement);